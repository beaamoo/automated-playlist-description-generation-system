...
def main(args) -> None:
    ...
    description_tokenizer = _tokenizer(dataset_type=args.dataset_type)
    ...
    if args.tokenzier == "white":
        ...
        raise ValueError("Current model only supports white space tokenizer")
    ...
    if args.model == "rnn":
        ...
        raise ValueError("Model type not supported. Please choose 'rnn' or 'transformer'.")
    ...
    pipeline = PlyPipeline(
                ...
                description_vocab=description_vocab,
    ...
    runner = Runner(model=model, 
                    ...
                    ) if args.model == "rnn" else TF_Runner(model=model, 
                                                             lr=args.lr, 
                                                             weight_decay=args.weight_decay, 
                                                             T_0=args.T_0,
                                                             vocab_size=output_size,)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_type", default="mpd", type=str)    
